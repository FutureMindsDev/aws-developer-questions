...
const questions = [
  {
    ...
    correctAnswer: "C",
    category: "Old Question 1"
  },
  {
    question: "A company is using AWS Elastic Beanstalk to deploy a three-tier application. The application uses an Amazon RDS DB instance as the database tier. The company wants to decouple the DB instance from the Elastic Beanstalk environment.\nWhich combination of steps should a developer take to meet this requirement? (Choose two.)",
    options: [
  ...
  },
  {
    ...
    options: [
      "Configure the application in Account B to use credentials for an IAM user in Account A that has access to the parameters.",
  ...
  },
  {
    ...
    options: [
      '"Condition":{"ArnLike":{"aws:SourceArn":"arn:aws:states:ap-south-1:1111111111111:stateMachine:myStateMachine"}}',
      '"Condition":{"ArnLike":{"aws:SourceArn":"arn:aws:states:ap-south-1:*:stateMachine:myStateMachine"}}',
      '"Condition":{"StringEquals":{"aws:SourceAccount":"111111111"}}',
      '"Condition":{"StringNotEquals":{"aws:SourceArn":"arn:aws:states:ap-south-1:1111111111111:stateMachine:myStateMachine"}}'
    ],
    correctAnswer: "A",
    category: "Old Question 2"
  },
